...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|----+----+----+----+----+----|              |----+----+----+----+----+----|
     TAB , Q  , D  , R  , W  , B  ,                K  , F  , U  , P  ,SCLN,BSPC,
  //|----+----+----+----+----+----|              |----+----+----+----+----+----|
     LCTL, A  , S  , H  , T  , G  ,                Y  , N  , E  , O  , I  ,QUOT,
  //|----+----+----+----+----+----+----.    ,----|----+----+----+----+----+----|
     LSFT, Z  , X  , M  , C  , V  ,RASE,     ENT , J  , L  ,COMM,DOT ,SLSH,RSFT,
  //`----+----+----+--+-+----+----+----/    \----+----+----+----+----+----+----'
  ...
  [_LOWER] = LAYOUT_kc(
  //,----+----+----+----+----+----.              ,----+----+----+----+----+----.
     AGRV,EXLM, AT ,HASH,DLR ,PERC,               CIRC,AMPR,ASTR,PSLS,NLCK,TILD,
  //|----+----+----+----+----+----|              |----+----+----+----+----+----|
     ATAB,LABK,LCBR,RCBR,RABK,BSLS,               UNDS, P7 , P8 , P9 ,PLUS,    ,
  //|----+----+----+----+----+----|              |----+----+----+----+----+----|
